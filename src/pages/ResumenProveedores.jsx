...
export default function ResumenProveedores() {
  ...
  useEffect(() => {
    if (openPago && proveedorId) {
      cargarComprasPendientes(proveedorId);
    }
  }, [openPago, proveedorId]);
  ...
  const guardarPago = async () => {
    ...
    try {
      ...
      await cargarComprasPendientes(proveedorId);
      await cargarPagos(proveedorId);
  ...
  const limpiarFiltros = () => {
    setproveedoresSeleccionado(null);
    setproveedorId("");
    setFechaDesde("");
    setFechaHasta("");
    setFacturas([]);
